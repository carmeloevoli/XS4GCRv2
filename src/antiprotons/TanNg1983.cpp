...
// Tan & Ng (1983) antiproton production parametrization (formerly models/apTanNg83).
namespace {
...
double TanNg1983SecAp::getDifferential(const PID& particle, const TARGET& target, const double& T_proj,
