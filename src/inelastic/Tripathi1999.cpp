...
// Tripathi et al. (1999) total inelastic cross-section parametrization (formerly models/inTripathi99).
namespace {
...
std::shared_ptr<TotalInelastic> Tripathi1999TotalInel::clone() { return std::make_shared<Tripathi1999TotalInel>(*this); }
