...
int main() {
  try {
    ...
    }
    {
      ...
      get_secondary_production(Pi0GammaModels::KAFEXHIU2014PYTHIA8, T_proj, "output/Kafexhiu2014P8_100GeV_gamma.txt");
    ...
    }
    {
      ...
      get_secondary_production(Pi0GammaModels::KAFEXHIU2014SIBYLL, T_proj, "output/Kafexhiu2014Sibyll_10GeV_gamma.txt");
    }
    {
      ...
      get_secondary_production(Pi0GammaModels::KAFEXHIU2014SIBYLL, T_proj, "output/Kafexhiu2014Sibyll_5GeV_gamma.txt");
    }
